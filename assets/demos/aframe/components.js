...
const cuboidVertices2 = [
    new THREE.Vector3(70, 10, 10),
    new THREE.Vector3(70, 10, 30),
    new THREE.Vector3(90, 10, 10),
    new THREE.Vector3(90, 10, 30),

    new THREE.Vector3(70, 30, 10),
    new THREE.Vector3(70, 30, 30),
    new THREE.Vector3(90, 30, 10),
    new THREE.Vector3(90, 30, 30)
]
...
build3dObjects('cuboid', cuboidVertices2);
